...
<head>
    ...
    <title>Laptop Report - Repair System</title>
    ...
    <main class="main-container">
        <div class="content-area">
            ...
            <div class="report-box">
                <h2><i class="fa-solid fa-laptop-file"></i> Warbixinta Dayactirka Laptops-ka</h2>
                ...
                <table class="report-table">
                    ...
                    <tbody>
                        <?php
                        $sql = "SELECT * FROM laptop_repairs ORDER BY id DESC";
                        ...
                        if ($result && $result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo "<td>" . htmlspecialchars($row['laptop_brand']) . "</td>";
                                echo "<td>" . htmlspecialchars($row['laptop_model']) . "</td>";
                                echo "<td>" . htmlspecialchars($row['laptop_issue']) . "</td>";
                                echo "<td>$" . number_format($row['repair_cost'], 2) . "</td>";
                                echo "<td>" . $row['created_at'] . "</td>";
                                echo "</tr>";
                            }
                        } else {
                            echo "<tr><td colspan='8'>Wax xog ah kama jiraan miiska dayactirka laptops-ka.</td></tr>";
                        }
                        $conn->close();
                        ?>
                    </tbody>
